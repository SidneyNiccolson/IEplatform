# Django settings for MetabolicMasterProject project.
import os
...
STATIC_ROOT =os.path.join(STATIC_PATH, 'assets')
print (STATIC_ROOT)
...
ROOT_URLCONF = 'IEMasterProject.urls'

# Python dotted path to the WSGI application used by Django's runserver.
WSGI_APPLICATION = 'IEMasterProject.wsgi.application'
...
LOGIN_REDIRECT_URL = 'bla/logged_in'
LOGIN_URL='puma/'