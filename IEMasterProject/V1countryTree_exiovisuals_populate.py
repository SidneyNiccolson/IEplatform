...
def add_child(parent, id, name, slug, local, lvl, lwst_level):
    e, created = Country.objects.get_or_create(parent=parent, id=id, name=name, slug=slug, local=local, lvl=lvl, lwst_level=lwst_level)

    return e

def add_parent(id,name, slug, local, lvl, lwst_level):
    e, created = Country.objects.get_or_create(id=id,name=name, slug=slug, local=local, lvl=lvl, lwst_level=lwst_level)
